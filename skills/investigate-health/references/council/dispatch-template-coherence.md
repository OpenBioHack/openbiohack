...
- **The interview answers:** `<root>/interview-answers.md` (the subject's own reports the verdicts must respect)
...
4. **Anti-escalation.** Does any verdict read as MORE confident than the deepening it cites justifies? A
   strengthen that rests on no new evidence — or that leans on a summary rather than the primary artifact —
   is a FAIL.
