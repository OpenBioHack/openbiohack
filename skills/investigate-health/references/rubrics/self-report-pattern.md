...
in `interview-answers.md` alongside the answer, with the provenance attached, so downstream
...
hours I get facial flushing the next morning. Observed at least 5 times
