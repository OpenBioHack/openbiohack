...
- **No hyperbole, no crowning a cause. Think with the nuance of a Keegan level-5 thinker.** Candidate
  ...
  plain observations, not as proof for or against a cause ("the elimination trial did not noticeably change it,"
  ...
  softer: "it could be one of the contributors, alongside others we can't separate yet," not "the symptom
  reads as a single mechanism."
